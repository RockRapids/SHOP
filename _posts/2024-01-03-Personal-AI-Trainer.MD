...
Mirror ... *or a big storefront window that you can look at while your lard ass walks by*: Interactive home gym with a large screen with your own personalized motivational reminder-PostIts stuck to them [because your vain ass is going to look at yourself in the mirror and notice that reminder-Post-It]. You might think this mirror thing is a joke, but people really do spend ginormously unbelievable serious amounts of money on the INDUSTRY known as ["workout mirrors"](https://www.cnet.com/health/fitness/best-mirror-workout/).

Apple Fitness+: Subscription service with on-demand workout videos and guidance by Apple Watch ... possibly the ONLY thing worse than celebrity horsehockey, are stinking iOS road Apples that have piled up everywhere on the info superhighway in the last 25 years ... *Apple product's are far WORSE than Gillette razor blades ever were that were sold to suckers who needed to shave to look like like WWI Vets who got in the habit of shaving to make sure the gas masks fit ...  the the Gillette design or advertisements had half of purpose, ie if you have ever been through a pepper spray training in the military or corrections or police work, you understand why gas masks need to fit ... but the problem with the Apple fritterware from the mock turtleneck crowd is their fashion statement cuts deeper*.

[FitOn](https://fitonapp.com/), like *HardOn*, except for **hard** workouts: Free workout videos across various disciplines with live and on-demand options ... *is that a* ***FitOn*** *or are you just happy to see me?*  As you might guess from an app clearly named to mine the erectile dysfunction comedy vein, the workouts practically write themselves ... 
...
Startups for Health: Tracks and reports on health-tech startups, which might include AI-powered trainers or, more generally, better adherence to a person's own VERY PERSONAL prescribed holistic treatment program, like [Sweetch](https://www.sweetch.com/solutions) ... it's understandably PERSONAL if there's a medical professional involved OR someone is on a court-ordered OR someone is incentivized by an employer-driven quasi-mandatory health improvement regimen ... AI *could* crossover into PERSONAL territory really quick if there's a PERSON of authority who's going to be using AI to drive accountability.
