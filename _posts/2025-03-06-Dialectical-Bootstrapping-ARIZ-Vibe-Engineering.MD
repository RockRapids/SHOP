...
Vibe engineering could be thought of as an AI-assisted mental combination of [dialectical bootstrapping](https://journals.sagepub.com/doi/10.1111/j.1467-9280.2009.02271.x) with the Russian TRIZ/ARIZ theory of inventive problem-solving.

Both approaches aim to smash through cognitive limitations with a framework that ideates the generation of what are mostly likely to be the seeds of better solutions ... dialectical bootstrapping with the Russian TRIZ/ARIZ theory of inventive problem-solving work through very different, but tangentially related ideation mechanisms. TRIZ provides structured patterns of innovation and contradiction resolution, while dialectical bootstrapping leverages cognitive diversity within a single mind. 
