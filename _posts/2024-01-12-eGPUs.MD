...
It's not just the far reaches of outer space, there's also plenty of room at the bottom ... perhaps you are interested in [exploring the nanoscale biological processes by advancing the limits of optical microscopy](https://forum.level1techs.com/t/minisforum-ar900i-mobo-with-i9-13900hx-with-gpu-assisted-global-shutter-gs-camera-sensor-rapid-motion-microscopy-machine-vision/205232)? We might ask, for example, ["Are there little AFFORDABLE-FOR-THE-MASSES microscopy projects, for cellular and molecular-level digital optical microscopy, in case families want to *share videos of their gut bacteria or new virus friends before/after the holidays on Instagram*"](https://bard.google.com/share/66ef676e6599) ... maybe that would lead to setting up a mini PC for a bit of an industrial machine vision application ... in which a [global shutter camera sensor]([an Arducam 2.3MP AR0234 Color Global Shutter](https://www.uctronics.com/arducam-2-3mp-ar0234-color-global-shutter-camera-usb2-0-evaluation-kit.html) is mounted in a modified [structured light](https://en.wikipedia.org/wiki/Structured_light) [epifluorescent microscope](https://en.wikipedia.org/wiki/Fluorescence_microscope) ... the objective would be achieving something like [super resolution computational saturated absorption microscopy](https://www.connectedpapers.com/main/b303b60d3e8a863558a0e1a9b8dbe990aeb57291/Super%20resolution-computational-saturated-absorption-microscopy./graph) or maybe GPU-assisted [total internal reflection fluorescence (TIRF) microscopy](https://arxiv.org/abs/2311.00590).
